...
DEFAULT_NLP_CONFIG = PROJECT_ROOT / "configs" / "bert.yaml"
DEFAULT_FEATURES_CONFIG = PROJECT_ROOT / "configs" / "features.yaml"
DEFAULT_NORMATIVE_CONFIG = PROJECT_ROOT / "configs" / "normative.yaml"
DEFAULT_NORMATIVE_RULES_CONFIG = PROJECT_ROOT / "configs" / "normative_rules.yaml"
